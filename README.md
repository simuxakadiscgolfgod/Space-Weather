...
Scale levels).
The greatest expected 3 hr Kp for Jan 19-Jan 21 2026 is 4.00 (below NOAA
Scale levels).
...
19 Jan, decaying to a chance on 20 Jan and a slight chance on 21 Jan.
...
Rationale: R1-R2 (Minor-Moderate) radio blackouts are likely and a
slight chance for R3 (Strong) radio blackouts over 19-21 Jan due to the
flare potential of multiple complex regions on the visible disk.
